...
export const selectFilter = state => state.filter; // експорт функції селектору selectFilter, що повертає значення пошуку (списку, що відповідає критеріям пошуку) зі стану сховища Redux (за допомогою виклика хука useSelector)
